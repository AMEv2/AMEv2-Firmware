...
#if CONFIG_LCD_SPI1_HOST
#define SPI_HOST    		SPI1_HOST
#elif CONFIG_LCD_SPI2_HOST
#define SPI_HOST    		SPI2_HOST
#elif CONFIG_LCD_SPI3_HOST
#define SPI_HOST    		SPI3_HOST
#else
#define SPI_HOST    		SPI2_HOST
#endif

#if CONFIG_LCD_I2C_NUM0
#define I2C_MASTER_NUM    		I2C_NUM_0
#elif CONFIG_LCD_I2C_NUM1
	...
	switch(msg) {
		...
		case U8X8_MSG_BYTE_INIT: {
          ...
          spi_bus_config_t bus_config;
                  ...
                  bus_config.miso_io_num = U8G2_ESP32_HAL_UNDEFINED;    // MISO
                  bus_config.quadwp_io_num = U8G2_ESP32_HAL_UNDEFINED;  // Not used
                  bus_config.quadhd_io_num = U8G2_ESP32_HAL_UNDEFINED;  // Not used
...
uint8_t u8g2_esp32_i2c_byte_cb(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr) {
	...
	switch(msg) {
		...
		case U8X8_MSG_BYTE_START_TRANSFER: {
            bufIdx = 0;
            ESP_LOGD(TAG, "Start I2C transfer to");
			break;
        }

		case U8X8_MSG_BYTE_END_TRANSFER: {
            ESP_LOGD(TAG, "End I2C transfer.");
            ESP_ERROR_CHECK(i2c_master_transmit(dev_handle, buf, bufIdx, -1));
			break;
		}
	}
	return 0;
